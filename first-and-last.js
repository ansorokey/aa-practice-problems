...
// and returns the sum of the first and last element if there is
// an even number of elements in the array.
// If there is an odd number of elements in the array, then
// the function should return the difference between
